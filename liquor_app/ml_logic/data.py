...
def clean_data(df: pd.DataFrame) -> pd.DataFrame:
    ...
    df = df.drop(['invoice_and_item_number','store_name','store_number','vendor_number',
                  'category','address','city','zip_code','item_number','item_description',
                  'store_location'], axis=1, errors='ignore')
